...
Contest Number: 3
Description of Bot: A slightly modified 2-speedyOffensiveAgent combination from masterReflexes, to pressure the 
opponent offensively.
"""
...
class SpeedyOffensiveAgent(ReflexCaptureAgent):
  ...
  def getWeights(self, gameState, action, features):
    ...
    go_for_food['distanceToTeammate'] = 20
