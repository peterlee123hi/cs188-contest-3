...
Contest Number: Final Contest
Description of Bot: 
Modified version of BaselineTeam with several modifications.
The Offensive Agent uses invisibillity to pilfer small amounts of pellets.
This low risk strategy evades detection and raises my score. Also, if not Pacman,
it is capable of performing basic defensive maneuvers when necessary,
The Defensive Agent uses a combination of fast speed and lasers to kill enemies
as efficiently as possible, noticing closing the enemies into killing range.
"""
...
class OffensiveReflexAgent(ReflexCaptureAgent):
  ...
  def choosePowers(self, gameState, powerLimit):
    ...
    # validPowers.remove('invisibility')
  ...
  def getWeights(self, gameState, action):
    return {'successorScore': 100, 'distanceToFood': -1, 'opponentsScared': 10, 'distanceToFood': -1,
        'invaderDistance': -15, 'stop': -50, 'reverse': -3}
