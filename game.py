...
class Game:
    ...
    def initializeCapsules(self):
        ...
        if not extraRedCapsules:
            print >>sys.stderr, "Red team took too long to chose capsules"
        elif not self.checkCapsules(extraRedCapsules, self.state.getRedCapsules(), self.capsuleLimit):
        ...
        if not extraBlueCapsules:
            print >>sys.stderr, "Blue team took too long to chose capsules"
        elif not self.checkCapsules(extraBlueCapsules, self.state.getBlueCapsules(), self.capsuleLimit):
